...
<html>
    ...
    <body onLoad="noBack();" onpageshow="if(event.presisted) noBack();" onunload="">
        ...
        <div class="header1">
            <div id="img3" class="header1"><img src="img/pdlogo.png" id="img3" /></div>
            <div id="profilearea5" class="header1"><a href="1_HomePage.jsp"style="color: #ffffff"> Home</a></div>
            <div id="profilearea" class="header1"><img src="img/pdlogo.png" id="profpic"/></div>
...
<%
            ...
            <div id="postboxpos" class="post">
                    ...
                    <h6 style="color:orchid"><br>(Text limit 300 letters)</h6>    
            </div>
       ...
       <%   try {
                ...
                %><div class="postdisplay2">
                    ...
                    <h4 style="float:right;margin-top:-15px"> <%=post_date%></h4>
                        ...
                        <img  class="test" src="C:\\Users\\hp\\Desktop\\Industrial-Training\\Project\\PocketDesk\\web\\images\\<%=img%>" alt="Avatar" >
